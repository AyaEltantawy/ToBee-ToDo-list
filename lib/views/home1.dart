...
import 'package:tobee_todo_list/views/deadlines2.dart';
import 'package:tobee_todo_list/views/recommendation_by_Ai.dart';
import 'package:tobee_todo_list/views/task_deadlines_page.dart';
 ...
 /* final List<Map<String, String>> dailyTasks = [
  ...
  SizedBox(width: 30,)
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  MaterialButton(
                    onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => TaskDeadlinesPage2()));},
                    minWidth: 153,
                    height: 47,
                    color: Colors.black,
                    shape: RoundedRectangleBorder(
    ...
    return _buildTaskCard(
     ...
     /* floatingActionButto n: FloatingActionButton(onPressed: () async {
        // Navigate to AddTaskPage and wait for the result
